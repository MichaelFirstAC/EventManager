...
Create a new database schema. You can do this by running the first two lines from your original SQL script:

CREATE DATABASE EventManagementSystem;
USE EventManagementSystem;


Run the rest of the SQL script you have to create all the tables (Venue, Organizer, Event, etc.) and insert the initial sample data.

Step 3: Configure the Backend

Navigate to the project's root directory (EventManagerPro) in your terminal.

Create and activate a Python virtual environment. This is highly recommended to keep dependencies isolated.
...
Find the db_config dictionary at the top and update it with your personal MySQL credentials (username, password, and port).
